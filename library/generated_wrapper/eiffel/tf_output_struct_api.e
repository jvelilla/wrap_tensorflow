...
feature {NONE} -- Implementation wrapper for struct struct TF_Output

	sizeof_external: INTEGER 
		external
			"C inline use <c_api.h>"
		alias
			"sizeof(struct TF_Output)"
		end
	...
	set_c_oper (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct TF_Output*)$an_item)->oper =  (TF_Operation*)$a_value
			]"
		ensure
	...
	c_index (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct TF_Output*)$an_item)->index
			]"
		end
	...
	set_c_index (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct TF_Output*)$an_item)->index =  (int)$a_value
			]"
		ensure
